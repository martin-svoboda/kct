...
function kct_setup() {
	/*
		...
		* If you're building a theme based on kct, use a find and replace
		* to change 'kct' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'kct', get_template_directory() . '/languages' );
