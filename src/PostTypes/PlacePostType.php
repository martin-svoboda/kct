...
class PlacePostType extends AbstractCustomPostType {
	const KEY = 'misto';
	...
	public function setup() {
		$items = array(
			array(
				'type'  => 'mapycz',
				'id'    => 'location',
				'title' => __( 'Pozice místa', 'kct' ),
			),
		);

		$this->wcf->create_metabox( array(
			'id'         => 'data',
			'title'      => __( 'Data místa', 'kct' ),
	...
	public function get_args(): array {
		$singular = _x( 'Místo', 'post type singular name', 'kct' );
		$plural   = _x( 'Místa', 'post type name', 'kct' );
