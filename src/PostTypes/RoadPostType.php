...
class RoadPostType extends AbstractCustomPostType {
	const KEY = 'trasa';
	...
	public function setup() {
		$items = array(
			array(
				'type'  => 'attachment',
				'id'    => 'gpx',
				'title' => __( 'GPX soubor trasy', 'kct' ),
			),
		);

		$this->wcf->create_metabox( array(
			'id'         => 'data',
			'title'      => __( 'Data trasy', 'kct' ),
	...
	public function get_args(): array {
		$singular = _x( 'Trasa', 'post type singular name', 'kct' );
		$plural   = _x( 'Trasy', 'post type name', 'kct' );
