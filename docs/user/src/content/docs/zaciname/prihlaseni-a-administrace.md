...
Stránka je rozdělená na tři záložky:

- **Obecné** — kód odboru nebo oblasti,
- **Facebook** — sdílení aktualit a akcí na facebookovou stránku odboru,
- **Turinka** — propojení s Turinkou.

Přepnutí mezi záložkami nic neukládá ani neztrácí: tlačítko **Uložit změny**
dole na stránce uloží všechny záložky najednou.
...
Jednotlivá pole popisují stránky [Akce](/funkce/akce/),
[Sdílení na Facebook](/funkce/sdileni-na-facebook/) a
[Turinka](/funkce/turinka/). Co vyplnit hned na
